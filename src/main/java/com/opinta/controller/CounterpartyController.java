...
public class CounterpartyController {
    private static final String NO_COUNTERPARTY_FOUND_FOR_ID_D = "No Counterparty found for ID %d";
    ...
    public ResponseEntity<?> getPostOffice(@PathVariable("id") long id) {
        ...
        if (counterpartyDto == null) {
            return new ResponseEntity<>(format(NO_COUNTERPARTY_FOUND_FOR_ID_D, id), NOT_FOUND);
        }
    ...
    public ResponseEntity<?> getClientsByCounterpartyId(@PathVariable long counterpartyId) {
        ...
        if (clientDtos == null) {
            return new ResponseEntity<>(format(NO_COUNTERPARTY_FOUND_FOR_ID_D, counterpartyId), NOT_FOUND);
        }
