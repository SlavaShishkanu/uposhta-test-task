...
/**
 * PostcodePool holds all postcodes ("00000"-"99999") and pool of the inner numbers for each
 * postcode It shouldn't have field like Client or PostOffice. Client and PostOffice should have
